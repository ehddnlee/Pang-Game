...
weapon = pygame.image.load(os.path.join(image_path, "pang_weapon.png"))
...
ball_images = [
    pygame.image.load(os.path.join(image_path, "pang_ball1.png")),
    pygame.image.load(os.path.join(image_path, "pang_ball2.png")),
    pygame.image.load(os.path.join(image_path, "pang_ball3.png")),
    pygame.image.load(os.path.join(image_path, "pang_ball4.png"))]
